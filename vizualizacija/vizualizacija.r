...
vekt1<-svet$name_long %in% rownames(sportniki) | svet$name_long=="Russian Federation"| svet$name_long=="Brunei Darussalam"| svet$name_long=="Ivory Coast"

# 
# #Logični vektor držav iz tabele sportniki, ki jih ni v zemljevidu svet
